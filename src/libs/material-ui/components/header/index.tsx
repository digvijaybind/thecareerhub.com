...
const navItems = [
  { text: "Career Test", color: "white",path:"/career-detail" },
  { text: "Blog", color: "white" ,path:"/blog-detail" },
  { text: "Login", color: "#fee040",path:"/" }
];
        ...
        <Toolbar>
          ...
          <Box sx={{ display: { xs: "none", sm: "block" } }}>
            <ButtonComponent
              ...
              text={"Explore"}
              style={{ color: "#fff", paddingLeft: 25, paddingRight: 25 }}
            />
            {navItems.map((item) => (
              <ButtonComponent
                key={item.text}
                ...
                style={{ color: item.color, paddingLeft: 25, paddingRight: 25 }}
              />
            ))}
          </Box>
