...
export default function HomeComponent() {
  const content=[
    ...
    heading:'Do you want a sneak peak of what your professional future will look like?',
    description:'It can be difficult to know your future, but it is not impossible! Get acquainted with with',
    points:[
...
'Most importantly- your growth chart'
    ...
    isButton:true,image:section1Img},
    {
      short:'Your map to a succesful career',
    heading:"You can see the goal, now let's race to it",
    description:"Now that you realise that your career is waiting for you at the end of the finish line, one should gear up for the race. And while nothing comes easy, doesn't mean that it can be enjoyable. That's why, the career pathways will assist you by:",
    points:[
...
'Aligning the pros and cons of each possible course of action'
    ...
    button:'',
    isButton:false,image:section2Img
  },
  {
    short:'Navigating to your destination',
  heading:"Prepare to prosper",
  description:"Considering that we spend most of our childhood, teenage, and even young adulthood years preparing for a career that will support you for the rest of your life, let's explore the best academic pursuits, and vocational training options knocking at your door",
  points:[
...
'Identify the prospects the course will open up for you'
  ...
  button:'Find Courses',
  isButton:true,image:section3Img
},
{
  short:'Major landmarks of your career story',
heading:"Only the best, for the best your educational environment matters",
description:"Guess what, even the top academic institutes are competeing within themselves to get you.  You also get to know about the college's",
points:[
...
isButton:true,image:section4Img
},
{
  short:'Your excellence can be limitless',
heading:"For a career as bright as your ambition",
description:"Learning is eternal, and ever useful. So why stop at good, when you deserve the best? In fact, we have summarised the key trends in the global economy and current job markets to amplify the opportunities available to you, by collating the facts, figures, and fundamentals of major",
points:[
'Industries',
'Internships',
'Improvements',
...
button:'',
isButton:false,image:section5Img
},
{
  short:"You can succeed, let's show you how",
heading:"Let's start with the most important factor- You",
description:"In this fast-paced world, what remains a constant is YOU. So let's find out what your strengths, interests, and traits are- our standardised tests will help the best suited career come to you. And here is how",
points:[
...
isButton:true,image:section6Img
  ...
  return (
    <>
     ...
     <div style={{background:"#013388",width:'100%',color:"white",height:400}}>
     <Container maxWidth="lg">
     <Grid container spacing={2}>
  <Grid item xs={6} style={{backgroundImage:`url(${interestSectionBG})`,   backgroundSize: 'cover',
        backgroundRepeat: 'no-repeat',
        backgroundPosition: 'center',}}>hello
{/* <Image src={interestSectionBG} style={{width:'100%'}} alt={"home background"}/> */}
  ...
  <Grid item xs={6}>
     ...
     <Container maxWidth="xl">
      {
        content.map((obj)=>(   <Grid container spacing={2}  paddingTop={10}>
            <Grid item md={6}>
          <Box
            sx={{
              position: 'relative',
          ...
          >
            ...
            <List sx={{ listStyleType: 'disc', pl: 4 }}>
              {
                obj.points.map((nestedObj)=>( <ListItem sx={{ display: 'list-item' }}>
{nestedObj}
            </ListItem>))
              }
          ...
          >
            <div style={{}}> <Image src={obj.image} style={{width:'100%'}} alt={"home background"}/></div>
      ...
      <Grid container spacing={2}  paddingTop={10}>
            <Grid item md={12}>
              <h1 style={{color:'#112152',textAlign:'center'}}>What our customers says</h1>
              
             <p  color="#2b2b2b" style={{textAlign:"center",fontFamily:'Poppins',fontSize:'18px',
              fontWeight: 'normal',
              fontStretch: 'normal',
              fontStyle: 'normal',
              lineHeight: 1,
