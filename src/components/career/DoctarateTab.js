...
class DoctarateTab extends React.Component {
  render() {
   ...
   let viewdetails = courses && courses.length > 0 ? <div><Link target="_blank" href={"/course?course_level=4"} className="viewallbtn">View All Related Courses List</Link></div> : null;
