    ...
    return (
      ...
      <nav className="project-tab">
        <div className="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
          <Link target="_blank"  className="nav-item nav-link" id="nav-home-tab" data-toggle="tab" href="#tab1" role="tab" aria-controls="nav-home" aria-selected="false">Diploma</Link>

          <Link target="_blank"  className="nav-item nav-link active" id="nav-profile-tab" data-toggle="tab" href="#tab2" role="tab" aria-controls="nav-profile" aria-selected="true">Degree</Link>
