  ...
  render() {
    return (
      ...
      <div className="leftsidebar hide-on-mobile">
        ...
        <SelectFilterWithoutSearch { ...this.props } type="duration" title="COURSE DURATION"/> <hr />
        <SelectFilterWithoutSearch { ...this.props } type="study_mode" title="STUDY MODE"/> <hr />
        <RangeFilter { ...this.props } type="course_fees" title="COURSE FEES"/> <hr />
