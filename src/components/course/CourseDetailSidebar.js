               ...
               <div className="col-md-12 moblistsec">
                  <div className="CareerDetailSidebar list-group">
                     <ul className="moblist">
                        <Link href="#coursesdesc" onClick={() => this.props.setActive('coursesdesc')}>
                           <li className={this.props.active === 'coursesdesc' ? 'active' : null}>Course Description</li> 
                        </Link>

                        <Link href="#od" onClick={() => this.props.setActive('od')}> 
                           <li className={this.props.active === 'od' ? 'active' : null} >
                           Other Details
                           </li> 
                        </Link> 

                        <Link href="#eligibility" onClick={() => this.props.setActive('eligibility')} >
                           <li className={this.props.active === 'eligibility' ? 'active' : null} >
                           Eligibility
                           </li>
                        </Link>

                        <Link href="#careers" onClick={() => this.props.setActive('careers')} >
                        ...
                        <Link href="#relatedcourses" onClick={() => this.props.setActive('relatedcourses')} >
